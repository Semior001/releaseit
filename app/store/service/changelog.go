...
func (s *ReleaseNotesBuilder) Build(cl store.Changelog) (string, error) {
...
func (s *ReleaseNotesBuilder) makeUnlabeledCategory(used []bool, prs []store.PullRequest) categoryTmplData {
